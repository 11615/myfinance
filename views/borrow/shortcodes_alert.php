...
<!-- Mirrored from jituchauhan.com/borrow/borrow/shortcodes-alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:57:13 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="bg-white pinside30">
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                <h1 class="page-title">Shortcodes Alerts</h1>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-12">
                                <div class="section-title mb30">
                                    <h1>Alerts</h1>
                                    <p class="lead">The <span class="highlight">Borrow Loan HTML Website Template</span> contains an alert box shortcode page that can be used to make announcements or highlight content.</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
