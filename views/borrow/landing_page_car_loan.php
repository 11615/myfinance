...
<!-- Mirrored from jituchauhan.com/borrow/borrow/landing-page-car-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:56:32 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <meta name="description" content="Looking for best car loan landing page template.">
            ...
            <div class="row d-flex align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-6">
                    <a href="index.html" id="branding">
                        <img src="<?php echo base_url();?>asset/images/logo.png" alt="Company Name" class="logo">
                    </a>
                    <!-- #branding -->
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-6 text-right"> <a href="index.html" class="btn btn-primary btn-sm">Back to Page</a></div>
            </div>
        </div>
        <!-- .container -->
    </div>
            ...
            <div class="row d-flex align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Instant Approval For Car Loan </h2>
                        ...
                        <a href="#!" class="btn btn-secondary btn-sm">Why Choose us ?</a>
                    </div>
                </div>
                <div class="offset-xl-1 col-xl-5 offset-lg-1 col-lg-5 col-md-6  col-sm-12 col-12">
                    <div class="request-form">
                        ...
                        <form method="post" action="https://jituchauhan.com/borrow/borrow/get-quote.php">
                            <!-- Text input-->
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <img src="<?php echo base_url();?>asset/images/lp-feature-img.jpg" alt="Borrow - Loan Company Responsive Website Templates" class="img-fluid w-100 mb-2 mb-lg-0">
                </div>
                <div class="offset-lg-1 col-lg-5 col-md-12">
                    <div class="mb60">
                        <h1>Reason to Choose us</h1>
                        <p>We offer award-winning, low-rate car loans with no ongoing fees,saving our customers thousands of dollars.</p>
                    </div>
                    ...
                    <div class="feature feature-left mb40">
                        ...
                        <div class="feature-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consng elit estibulum scelerisque imperdiet lacus.</p>
                        </div>
                    </div>
                    <div class="feature feature-left mb40">
                        <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="section-title text-center mb60">
                        ...
                        <p>Porttitor aceseu efficitur non lorem acese its do remmselorem ipusm dolro sit commodo.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="testimonial-simple text-center">
                        ...
                        <div>
                            <div class="client-rating">
                                <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-remain
"></i>
                            </div>
                            <span class="testimonial-name-inverse">Donny J. Griffin (baroda)</span>
                        </div>
                    </div>
                </div>
                <!-- /.testimonial simple start -->
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="testimonial-simple text-center">
                        ...
                        <div>
                            <div class="client-rating">
                                <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done
"></i>
                            </div>
                            <span class="testimonial-name-inverse">Ryder Lothian (A’bad)
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="testimonial-simple text-center">
                        ...
                        <div>
                            <div class="client-rating">
                                <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-done"></i> <i class="fa fa-star rate-remain"></i> <i class="fa fa-star rate-remain
                                "></i> </div>
                            <span class="testimonial-name-inverse">Brock Lambrick (surat)
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="mb-5 mb-lg-0">
                        ...
                        <h2>Ask about our low rate car loans?</h2>
                ...
                <div class="offset-xl-1 col-xl-7 offset-lg-1 col-lg-7 col-md-12 col-sm-12 col-12">
...
<!-- Mirrored from jituchauhan.com/borrow/borrow/landing-page-car-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:56:33 GMT -->
</html>