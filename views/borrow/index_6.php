...
<!-- Mirrored from jituchauhan.com/borrow/borrow/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:56:06 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/<?php echo base_url();?>asset/css/all.css"> -->
...
<body>
    <!-- /.top-bar -->
    <div class="header-primary sticky-top">
        <!-- /.top-bar -->
        <nav class="navbar navbar-expand-lg navbar-light bg-primary py-3">
            <div class="container">
                <a href="index.html" class="navbar-brand"><img src="<?php echo base_url();?>asset/images/logo-white.png" alt="Borrow - Loan Company Website Template"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class=" ml-lg-2">
                        <p class="mb-0 lead text-white font-weight-bold">1-800-123-4567</p>
                    </div>
                </div>
            </div>
        </nav>
                    ...
                    <div class="hero-tab-block">
                        <div class="st-tabs">
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mt30 nopl nopr">
                                                    <a href="#!" class="btn btn-secondary btn-lg">get your loan</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="loan-form">
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mt30 nopl nopr">
                                                    <a href="#!" class="btn btn-secondary">get your loan</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab-1" data-toggle="tab" href="#service1" 
                                    role="tab" aria-controls="service1" aria-selected="true"><i class="fa fa-money fa-lg"></i>
                                        <p> Personal</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-2" data-toggle="tab" href="#service2" role="tab"
                                     aria-controls="service2" aria-selected="false"><i class="fa fa-briefcase fa-lg"></i>
                                        <p>Business</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-3" data-toggle="tab" href="#service3" role="tab" 
                                    aria-controls="service3" aria-selected="false"><i class="fa fa-home fa-lg"></i>
                                        <p>Home</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-4" data-toggle="tab" href="#service4"
                                     role="tab" aria-controls="service4" aria-selected="false"><i class="fa fa-car fa-lg"></i>
                                        <p>Car</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-5" data-toggle="tab" href="#service5" role="tab" 
                                    aria-controls="service5" aria-selected="false"><i class="fa fa-graduation-cap fa-lg"></i>
                                        <p>Education</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-6" data-toggle="tab" href="#service6" role="tab"
                                     aria-controls="service6" aria-selected="false"><i class="fa fa-credit-card fa-lg"></i>
                                        <p>Credicard</p>
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="bg-white number-block mb30 ">
                        <div class="process-img"><img src="<?php echo base_url();?>asset/images/process-img-1.jpg" alt="Borrow - Loan Company Responsive Website Templates" class="rounded-circle img-fluid">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="bg-white number-block mb30 ">
                        <div class="process-img"><img src="<?php echo base_url();?>asset/images/process-img-2.jpg" alt="Borrow - Loan Company Responsive Website Templates" class="rounded-circle img-fluid">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="bg-white number-block mb30 ">
                        <div class="process-img"><img src="<?php echo base_url();?>asset/images/process-img-3.jpg" alt="Borrow - Loan Company Responsive Website Templates" class="rounded-circle img-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                    <div class="text-center">
                        <a href="#!"><img src="<?php echo base_url();?>asset/images/logo-big-1.png" alt="Borrow - Loan Company Responsive Website Templates"></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                    <div class="text-center">
                        <a href="#!"><img src="<?php echo base_url();?>asset/images/logo-big-2.png" alt="Borrow - Loan Company Responsive Website Templates"></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                    <div class="text-center">
                        <a href="#!"><img src="<?php echo base_url();?>asset/images/logo-big-3.png" alt="Borrow - Loan Company Responsive Website Templates"></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                    <div class="text-center">
                        <a href="#!"><img src="<?php echo base_url();?>asset/images/logo-big-4.png" alt="Borrow - Loan Company Responsive Website Templates"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url();?>asset/js/nice-select.js"></script>
    <script src="<?php echo base_url();?>asset/js/fastclick.js"></script>
   
</body>


<!-- Mirrored from jituchauhan.com/borrow/borrow/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:56:09 GMT -->
</html>