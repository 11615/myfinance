...
<!-- Mirrored from jituchauhan.com/borrow/borrow/gallery-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:57:03 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="bg-white pinside30">
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                <h1 class="page-title">Gallery Masonary</h1>
                            </div>
                    ...
                    <div class="wrapper-content bg-white p-3 p-lg-5 ">
                        <div class="row" data-isotope='{"layoutMode": "masonry"}'>
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
                                    <img src="<?php echo base_url();?>asset/images/masonry-1.jpg" alt="...">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
                                    <img src="<?php echo base_url();?>asset/images/masonry-2.jpg" alt="...">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
                                    <img src="<?php echo base_url();?>asset/images/masonry-3.jpg" alt="...">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
                            ...
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
                                    <img src="<?php echo base_url();?>asset/images/masonry-4.jpg" alt="...">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
                                    <img src="<?php echo base_url();?>asset/images/masonry-5.jpg" alt="...">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
                                    <img src="<?php echo base_url();?>asset/images/masonry-6.jpg" alt="...">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mb-4">
                                <a class="" href="#!">
...
<!-- Mirrored from jituchauhan.com/borrow/borrow/gallery-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:57:08 GMT -->
</html>