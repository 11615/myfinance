...
<!-- Mirrored from jituchauhan.com/borrow/borrow/shortcodes-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:57:13 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <meta name="description" content="Website template contains an tables shortcode page that can be used to mangae your table content.">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Shortcodes Tables</li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="bg-white pinside30">
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                <h1 class="page-title">Shortcodes Tables</h1>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-title mb30">
                                    <h1>Tables</h1>
                                    <p class="lead">The <span class="highlight">Borrow Loan HTML Website Template</span> contains an tables shortcode page that can be used to mangae your table content.
                                    </p>
                                </div>
                            </div>
                        </div>
