...
<!-- Mirrored from jituchauhan.com/borrow/borrow/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:55:48 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="slider-captions">
                        ...
                        <p class="slider-text d-none d-xl-block d-lg-block d-md-block">The low rate you need for the need you want! Call
                            <br> (555) 123-4567</p>
                        <a href="loan-listing-image.html" class="btn btn-secondary ">get started today</a>
                    </div>
                    <!-- /.slider-captions -->
                </div>
            </div>
                ...
                <div class="container">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="slider-captions">
                            ...
                            <a href="loan-listing-image.html" class="btn btn-secondary ">View Products</a>
                        </div>
                        <!-- /.slider-captions -->
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="service-img-box mb30 text-center outline">
                        <div class="service-img">
                            <a href="personal-loan.html" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img.jpg" alt="Borrow - Loan Company Website Template " class="img-fluid"></a>
                        </div>
                        <div class="service-content bg-white pinside20">
                            <h2 class="mb-0"><a href="personal-loan.html" class="title">Personal Loan</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="service-img-box mb30 text-center outline">
                        <div class="service-img">
                            <a href="home-loan.html" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img-1.jpg" alt="Borrow - Loan Company Website Template " class="img-fluid"></a>
                        </div>
                        <div class="service-content bg-white pinside20">
                            <h2 class="mb-0"><a href="home-loan.html" class="title">Home Loan</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="service-img-box mb30 text-center outline">
                        <div class="service-img">
                            <a href="education-loan.html" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img-2.jpg" alt="Borrow - Loan Company Website Template " class="img-fluid"></a>
                        </div>
                        <div class="service-content bg-white pinside20">
                            <h2 class="mb-0"><a href="education-loan.html" class="title">Education Loan</a></h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog-single.html" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-post-3.jpg" alt="Borrow - Loan Company Website Templates" class="img-fluid"></a>
                        </div>
                        <div class="bg-white pinside40 outline">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 clearfix">
                    <div class="testimonial-block mb30 text-center">
                        <div class=" mb20 testimonial-img-1"> <img src="<?php echo base_url();?>asset/images/testimonial-img.jpg" alt="Borrow - Loan Company Website Template" class="img-circle"> </div>
                        <div class="mb20">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 clearfix">
                    <div class="testimonial-block mb30 text-center">
                        <div class="mb20 testimonial-img-1"> <img src="<?php echo base_url();?>asset/images/testimonial-img-1.jpg" alt="Borrow - Loan Company Website Template" class="img-circle"> </div>
                        <div class="mb20">
    ...
    <div class="section-space40 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 mb-2"> <img src="<?php echo base_url();?>asset/images/logo-1.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 mb-2"> <img src="<?php echo base_url();?>asset/images/logo-2.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 mb-2"> <img src="<?php echo base_url();?>asset/images/logo-3.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 mb-2"> <img src="<?php echo base_url();?>asset/images/logo-4.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 mb-2"> <img src="<?php echo base_url();?>asset/images/logo-5.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 mb-2"> <img src="<?php echo base_url();?>asset/images/logo-1.jpg" alt="Borrow - Loan Company Website Template"> </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from jituchauhan.com/borrow/borrow/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:55:49 GMT -->
</html>