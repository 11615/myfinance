                            ...
                            <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8 col-8">
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                        <div class="btn-action"> <a href="contact" class="btn btn-primary">Get a call back</a> <a href="loan_calculator" class="btn btn-secondary">Emi Calculator</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12 col-sm-12 col-12">
                    <div class="wrapper-content bg-white">
                        <div class="section-scroll pinside60" id="section-about">
                            ...
                            <a href="#!" class="btn btn-secondary">Apply for loan</a> </div>
