...
<!-- Mirrored from jituchauhan.com/borrow/borrow/home-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:56:40 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <meta name="description" content="Myfinance - is the loan company, Business Website Template.">
                    ...
                    <div class="bg-white pinside30">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8 col-8">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-12 d-none d-xl-block d-lg-block">
                                        <div class="rate-block text-right">
                                            <h1 class="rate-number">9.50%</h1>
                                            <small>Rate of Interest</small> </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                        <div class="btn-action"> <a href="contact" class="btn btn-primary">Get a call back</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12 col-sm-12 col-12">
                    <div class="wrapper-content bg-white">
                        <div class="section-scroll pinside60" id="section-about">
                            <h1>About Loan</h1>
                            <p class="lead">To make your loan journey a smooth sail, in this article we will help you to know eligibility criteria, rates of interest, process, necessary documents, comparison and transfer for lowest rates. </p>
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12">
                                        <div class="feature-blurb mb60">
                                            <h3>New Home</h3>
                                            <p>New Loan at basic interest rates from myfinance. You can apply online and check your eligibility and easy EMI. Fast Approval for your new loan. </p>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12">
                                        <div class="feature-blurb mb60">
                                            <h3> Conversion</h3>
                                            <p>A conversion loan is a scheme for those who have already taken a housing loan. This loan follow some rules and regulations.It is a part of loan. </p>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12">
                                        <div class="feature-blurb mb60">
                                            <h3>Land Purchase</h3>
                                            <p> Loan offers loan for land purchase to make your dream home. You can compare loan rates with our compare loan table. Apply online for Loan.</p>
                                        </div>
                                    </div>
                                   <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12">
                                        <div class="feature-blurb mb60">
                                            <h3>Renovation</h3>
                                            <p>Get instant approval for renovation your home. It is with basic rate and flexible EMI repayment.For more detail you can check our loan products. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from jituchauhan.com/borrow/borrow/home-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:56:41 GMT -->
</html>
