...
<head>
  ...
  <title>Borrow Admin Panel</title>
    ...
    <!-- Sidebar -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('admin/loginA');?>" class="nav-link">
              <i class="nav-icon"></i>
              <p>
                Admin Login
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('admin/contact_table');?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('admin/lead_table');?>" class="nav-link">
